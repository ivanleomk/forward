...
const Mentor = ({item}) => {
    const {name, location, title, industry} = item;
    return (
        <div class="m-10">
            <div class="text-center mb-4 opacity-90">
                <a href="#" class="block relative">
                    <img
                        ...
                        class="mx-auto rounded-full h-40 w-40 "
                    />
                </a>
            </div>
            <div class="text-center">
                <p class="text-2xl text-gray-800 dark:text-white">{name}</p>
                <p class="text-xl text-gray-500 dark:text-gray-200 font-light">{title}</p>
                <p class="text-md text-gray-500 dark:text-gray-400 max-w-xs py-4 font-light">
                    {name} is a {title} working in {location} in the {industry} industry!
                </p>
            </div>
